            ...
            <Form>
                ...
                >
                    <Col md="5">
                        <input
                            ...
                            onSelect={e =>
                                e.target.id !== currentField && onFieldChange(e)
                            }
                ...
                >
                    <Col md="5">
                        <input
                            ...
                            type="text"
                            value={
                                currentField === 'beckettId'
                                    ? tempText
                                    : interestForm.beckettId
                            }
                            className="transparent-text-input border border-dark rounded-pill"
                ...
                >
                    <Col
                        md="5"
                        align="left"
                        className="checkbox-array rounded-custom"
                    >
