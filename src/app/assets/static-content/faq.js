...
export const faq = {
  ...
  sectionTitles: [
    'Why Vault?',
    'What makes the Beckett Vault Different?',
    'What kind of collectibles can I vault?',
    'How do I submit my items?',
    'How do I withdraw my items?',
    'How do I trade my items?',
    'How secure is the vault?',
    'Can I see my vaulted items?',
    'What does it cost?',
  ],
  sectionContent: [
    {
    ...
    },
    {
      type: 'p',
      content: [
        `Beckett Vault is different from its competitors by offering personal concierge 
    ...
    },
    {
      type: 'p',
      content: [
        `First create an account with Beckett Vault, once logged in you can submit one 
    or more graded cards or comics via the submission form. After the submission form 
    has been completed, print out the shipping insert and place it in a safely packed 
    box. Drop your package off at the nearest post office and ship to Beckett’s 
